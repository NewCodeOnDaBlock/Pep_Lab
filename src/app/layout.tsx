...
export const metadata: Metadata = {
  ...
  keywords: ["research peptides", "BPC-157", "TB-500", "research chemicals", "peptide research"],
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${geistMono.variable} ${orbitron.variable} ${spaceGrotesk.variable}`}
    >
      <body className="bg-[#020408] text-[#e8f4f8] min-h-screen antialiased noise">
        <ResearchBanner />
        <Navbar />
